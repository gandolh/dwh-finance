...
def run_aggregation():
    spark_session = SparkSession.builder \
        ...
        .config("spark.mongodb.write.connection.uri", "mongodb://localhost:27017/dwh_finance.analytics_results") \
    ...
    aggregated_data_frame = data_frame.groupBy("assetId", "providerId", "year") \
        .agg(
